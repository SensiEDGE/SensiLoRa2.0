...
#define TS_ON 0          /*!< Log with TimeStamp */
...
/**
  ...
  */
#define UTIL_SEQ_ENTER_CRITICAL_SECTION( )   UTILS_DISABLE_IRQ()

/**
  * @brief macro used to exit the critical section
  */
#define UTIL_SEQ_EXIT_CRITICAL_SECTION( )    UTILS_ENABLE_IRQ()
...
/**
  * @brief macro used to initialize the critical section. Interruption is not prohibited, since USB is used
  */
...
#define UTILS_DISABLE_IRQ() uint32_t rimask_bit= __get_PRIMASK(); \
    __disable_irq();

/**
  * @brief macro used to exit the critical section
  */
#define UTILS_ENABLE_IRQ() __set_PRIMASK(rimask_bit);
